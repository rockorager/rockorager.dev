...
paste notification omits `loc`. The second form reads from the primary selection
and is used when the paste notification includes `loc=primary`.
...
Standard bracketed paste (mode 2004) is NOT used.
